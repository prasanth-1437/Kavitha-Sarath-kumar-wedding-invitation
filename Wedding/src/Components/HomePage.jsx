  ...
  return (
    <div className="home-page">
      ...
      <header id="Home" className="hero-section">
        <div><h1>Pilla's Wedding Invitation</h1></div>
        <br></br><br></br>
        <br></br><br></br>
     ...
     <br></br><br></br>
      ...
      <section id="invitation" className={isToggled?"invitation-details":"invitation-detailsD"}>
       <b> <h2 id='headings'>Mr. Pilla Apparao & Mrs. Chandra</h2></b>
        <p>We cordially invite you and your family to the auspicious occasion of the wedding of our only daughter:</p>
        <img id="couple" src={couple}/>
        <h3>Kavitha</h3>
        <p>With</p>
        <h3>Sarath Kumar</h3>
     
        <p>(Younger son of Mr. Gudela Srinivasarao & Mrs. Lakshmi from Telaprolu Village, Unguturu Mandal, Krishna Dist)</p>
        ...
        <p>Lunch follows ...</p>
         ...
         {card?<></>:<><img src={CARD} style={{width:"100%"
         }}/></>}
        <h4>Invited by:</h4>
        <p>Mr. Pilla Apparao & Mrs. Chandra</p>
...
<i className="fas fa-location-dot" style={{ color: "red", fontSize: "2.5em" }}></i>
      ...
      <section className={isToggled?'contact':'contactD'}>
        <h3>Contact</h3>
        <p>P.Apparao : 9394303636</p>
        <p>P.Hemanth : 8801327909</p>
        <p>P.Lokesh  : 7095652251</p>
      </section>
      <br></br>
